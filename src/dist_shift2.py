...
parser.add_argument('--seed', required=False, default=123123, type=int)
...
parser.add_argument('--d_model', required=False, default=5, type=int)
parser.add_argument('--n_layer', required=False, default=3, type=int)
parser.add_argument('--dr', required=False, default=0.1, type=float)
parser.add_argument('--model', required=False, default="MQRnn", choices=("DeepAR", "MQRnn", "TFT"), type=str)
